...
- `src/shared/logging/` contains the database-independent Pino core and environment-local Drizzle settings store/cache. `scripts/logging/` provides protected inspection and revision-checked edits. Application adoption remains T-26.3 work; [core evidence](../docs/agentforge/evidence/2026-09-19-logger-core.md) and [settings evidence](../docs/agentforge/evidence/2026-09-19-logger-settings.md) record proof and limits.
