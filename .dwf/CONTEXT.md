...
- The committed migration chain under `migrations/` is Better Auth plus lists/tasks. Read-only Production inspection after the approved releases found six expected tables and two migration journal entries. Applied shared/Production history is immutable; use reviewed forward migrations. No Production seed or reset ran.
