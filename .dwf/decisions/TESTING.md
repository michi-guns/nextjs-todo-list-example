...
| [TST-LOGGING-002](#tst-logging-002)         | Shared policy refresh and protected edits preserve environment isolation             | Unit, PostgreSQL integration, operator refusal checks                | T-26.2, T-26.3                                                     | `partial`   |
...
- **Current evidence:** T-26.2 provides the settings store/cache, runtime composition and protected TypeScript CLI. [Settings evidence](../../docs/agentforge/evidence/2026-09-19-logger-settings.md) records focused cache/CLI checks and real disposable PostgreSQL persistence, independent-instance convergence, revision conflicts, target isolation and timeout cleanup. T-26.3 application adoption/runtime evidence remains outstanding; operator inspection does not prove all active instances have adopted a revision. Migration smoke and integration gates are recorded in the linked evidence.
