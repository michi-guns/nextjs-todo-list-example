...
- Contracts/evidence: `TST-FOUNDATION-001`, `TST-HARNESS-001`, `TST-MIGRATION-001` where local evidence applies, `TST-AUTH-002`, `TST-LANDING-002`, and `TST-E2E-001`–`TST-E2E-003`; record Docker-daemon outage evidence only if observed.
