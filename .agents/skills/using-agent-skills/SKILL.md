...
Task arrives
    ...
    ├── PostgreSQL migration work? ───→ postgresql-migration-workflow
...
| Build  | postgresql-migration-workflow     | Classify environment state before consolidating or appending migrations    |
