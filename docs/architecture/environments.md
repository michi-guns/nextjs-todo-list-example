...
| Production  | Approved exact-ref deployment, separately protected Neon project/branch  | Resend with verified owner domain; Production CMS policy | T-21.5 mail foundation verified, including protected execution; T-23 release remains pending |
